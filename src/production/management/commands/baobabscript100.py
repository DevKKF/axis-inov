        ...
        try:
            ...
            for aliment_baobab in aliments_baobab:
                ...
                if len(aliment_formule) == 3:
                    if aliment_formule[0].formule_id == 4182 and aliment_formule[1].formule_id == 5128 and aliment_formule[2].formule_id == 4191:

                        # Traitement pour les bénéficiaires ayant les formules 5128 et 4191

                        aliment_formule[1].date_debut = "2024-01-01"
                        aliment_formule[1].date_fin = "2024-01-01"
                        aliment_formule[1].observation = "TRAITEMENT BAOBAB 20/06/2024"
                        aliment_formule[1].save()

                        aliment_formule[2].date_debut = "2024-01-01"
                        aliment_formule[2].date_fin = "2024-01-01"
                        aliment_formule[2].observation = "TRAITEMENT BAOBAB 20/06/2024"
                        ...
                        new_formule_aliment = AlimentFormule.objects.create(
                            ...
                            observation="TRAITEMENT BAOBAB 20/06/2024"
                        )
