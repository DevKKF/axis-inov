        ...
        try:
            ...
            for aliment_baobab in aliments_baobab:
                ...
                if len(aliment_formule) == 3:
                    ...
                    if aliment_formule[0].formule_id == 4155 and aliment_formule[1].formule_id == 5125 and aliment_formule[2].formule_id == 4164:

                        # Traitement pour les bénéficiaires ayant les formules 5125 et 4164

                        aliment_formule[1].date_debut = "2024-01-01"
                        aliment_formule[1].date_fin = "2024-01-01"
                        aliment_formule[1].observation = "TRAITEMENT BAOBAB"
                        aliment_formule[1].save()

                        aliment_formule[2].date_debut = "2024-01-01"
                        aliment_formule[2].date_fin = "2024-01-01"
                        aliment_formule[2].observation = "TRAITEMENT BAOBAB"
